 ...
 *  - [net.spacenx.messenger.data.remote.socket.quic.WebTransportQuicSocket] — QUIC (옵션, 포트 18029, minSdk 31)
 *
 * 8-byte header + JSON body 프레임 포맷은 [net.spacenx.messenger.data.remote.socket.codec.BinaryFrameCodec] 공유.
 * HI/NOOP/REFRESH_TOKEN 등 상위 로직은 [net.spacenx.messenger.service.socket.SocketSessionManager] 에서 전송 무관하게 동작한다.
 */
